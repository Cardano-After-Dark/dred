        ...
        <ReactMarkdown> {
            ...
            <p>
                <b>Instance properties: </b>
                                <a href="#MerkleMembership"><var>MerkleMembership</var></a>, &nbsp;
                    <a href="#MerkleStateRoot"><var>MerkleStateRoot</var></a>, &nbsp;
                    <a href="#NamedTokenRef"><var>NamedTokenRef</var></a>
            </p>
         <p>
            <b>Instance methods: </b>
                    <a href="#DelegateThreads"><var>DelegateThreads()</var></a>, &nbsp;
...
<p></p>
        ...
        <ReactMarkdown> {
            ...
            <pre><code lang="typescript">
{"DelegateThreads(fields: "}<a href="#ManifestEntryType$DelegateThreadsLike_2">{"ManifestEntryType$DelegateThreadsLike_2"}</a>{" | {\n        role: "}<a href="#DelegateRoleLike_2">{"DelegateRoleLike_2"}</a>{";\n        refCount: "}<a href="#IntLike">{"IntLike"}</a>{";\n    }"}{"): "}<a href="#UplcData">{"UplcData"}</a>{";"}
            </code></pre>
...
<p></p>
        ...
        <ReactMarkdown> {
            ...
            <pre><code lang="typescript">
{"DgDataPolicy(fields: "}<a href="#ManifestEntryType$DgDataPolicyLike_2">{"ManifestEntryType$DgDataPolicyLike_2"}</a>{" | {\n        policyLink: "}<a href="#RelativeDelegateLinkLike_3">{"RelativeDelegateLinkLike_3"}</a>{";\n        idPrefix: string;\n        refCount: "}<a href="#IntLike">{"IntLike"}</a>{";\n    }"}{"): "}<a href="#UplcData">{"UplcData"}</a>{";"}
            </code></pre>
