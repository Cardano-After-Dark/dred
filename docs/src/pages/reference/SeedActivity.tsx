        ...
        <div>
            ...
            <p>
                <b>Instance properties: </b>
                                <a href="#arg"><var>arg</var></a>
            </p>
         <p>
            <b>Instance methods: </b>
                    <a href="#mkRedeemer"><var>mkRedeemer()</var></a>
        </p>
...
{"arg: "}<a href="#SeedActivityArg">{"SeedActivityArg"}</a>{"<FactoryFunc>"}{";"}
            </code></pre>
    ...
    <h3>Instance methods</h3>
        ...
        <ReactMarkdown>
            ...
            <pre><code lang="typescript">
{"mkRedeemer(seedFrom: "}<a href="#hasSeed">{"hasSeed"}</a>{"): "}{"any"}{";"}
            </code></pre>
