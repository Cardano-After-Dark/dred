        ...
        <div>
         ...
         <p>
            <b>Instance methods: </b>
                    ...
                    <a href="#mkTxnRegisteringNeighborhood"><var>mkTxnRegisteringNeighborhood()</var></a>, &nbsp;
                    <a href="#mkTxnUpdatingNeighborhood"><var>mkTxnUpdatingNeighborhood()</var></a>, &nbsp;
...
<div className="prose">
        ...
        <ReactMarkdown>
            ...
            <pre><code lang="typescript">
{"dataBridgeClass: "}{"typeof "}<a href="#NeighborhoodPolicyDataBridge">{"NeighborhoodPolicyDataBridge"}</a>{";"}
            </code></pre>
...
{"get recordTypeName(): "}{"string"}{";"}
    ...
    <h3>Instance methods</h3>
        ...
        <ReactMarkdown>
            ...
            <pre><code lang="typescript">
{"exampleData(): "}<a href="#minimalNeighborhoodData">{"minimalNeighborhoodData"}</a>{";"}
            </code></pre>
...
<div className="prose">
        <a id="mkTxnRegisteringNeighborhood"></a>

            <div>
        <h4 style={{display: "inline-block"}}>    {
              "mkTxnRegisteringNeighborhood"}()&nbsp;&nbsp;</h4>
        <ReactMarkdown>
            {
                ""
            }
            ...
            <pre><code lang="typescript">
{"mkTxnRegisteringNeighborhood(this: "}<a href="#NeighborhoodController">{"NeighborhoodController"}</a>{", nbhReg: "}<a href="#minimalNeighborhoodData">{"minimalNeighborhoodData"}</a>{", initialTcx?: "}<a href="#StellarTxnContext">{"StellarTxnContext"}</a>{"): "}<a href="#Promise">{"Promise"}</a>{"<import(\"@donecollectively/stellar-contracts\")."}<a href="#hasUutContext">{"hasUutContext"}</a>{"<\"recordId\" | \"nbhd\"> & "}<a href="#StellarTxnContext">{"StellarTxnContext"}</a>{"<import(\"@donecollectively/stellar-contracts\")."}<a href="#anyState">{"anyState"}</a>{"> & import(\"stellar-tokenomics\")."}<a href="#hasMemberToken">{"hasMemberToken"}</a>{" & import(\"@donecollectively/stellar-contracts\")."}<a href="#hasSeedUtxo">{"hasSeedUtxo"}</a>{" & import(\"@donecollectively/stellar-contracts\")."}<a href="#hasCharterRef">{"hasCharterRef"}</a>{">"}{";"}
            </code></pre>
...
<div className="prose">
        <a id="mkTxnUpdatingNeighborhood"></a>

            <div>
        <h4 style={{display: "inline-block"}}>    {
              "mkTxnUpdatingNeighborhood"}()&nbsp;&nbsp;</h4>
        <ReactMarkdown>
            {
                ""
            }
            ...
            <pre><code lang="typescript">
{"mkTxnUpdatingNeighborhood(this: "}<a href="#NeighborhoodController">{"NeighborhoodController"}</a>{", txnName: "}{"string"}{", nbh: "}<a href="#FoundDatumUtxo">{"FoundDatumUtxo"}</a>{"<"}<a href="#ErgoNeighborhoodData">{"ErgoNeighborhoodData"}</a>{" | "}<a href="#NeighborhoodData">{"NeighborhoodData"}</a>{">"}{", options: "}<a href="#Omit">{"Omit"}</a>{"<"}<a href="#DgDataUpdateOptions">{"DgDataUpdateOptions"}</a>{"<"}<a href="#NeighborhoodDataLike">{"NeighborhoodDataLike"}</a>{">, \"activity\"> & {\n        activity?: "}<a href="#DgDataUpdateOptions">{"DgDataUpdateOptions"}</a>{"<"}<a href="#NeighborhoodDataLike">{"NeighborhoodDataLike"}</a>{">[\"activity\"];\n    }"}{", initialTcx?: "}<a href="#StellarTxnContext">{"StellarTxnContext"}</a>{"): "}<a href="#Promise">{"Promise"}</a>{"<"}<a href="#StellarTxnContext">{"StellarTxnContext"}</a>{"<import(\"@donecollectively/stellar-contracts\")."}<a href="#anyState">{"anyState"}</a>{"> & import(\"stellar-tokenomics\")."}<a href="#hasMemberToken">{"hasMemberToken"}</a>{" & import(\"@donecollectively/stellar-contracts\")."}<a href="#hasSeedUtxo">{"hasSeedUtxo"}</a>{">"}{";"}
            </code></pre>
