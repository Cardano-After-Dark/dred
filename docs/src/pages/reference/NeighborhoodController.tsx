        ...
        <div>
         ...
         <p>
            <b>Instance methods: </b>
                    ...
                    <a href="#mkTxnRegisteringNode">mkTxnRegisteringNode</a>, 
...
{"exampleData(): "}<a href="#minimalNeighborhoodData">{"minimalNeighborhoodData"}</a>{";"}
        ...
        <h4>    <b>{"mkTxnRegisteringNode"}</b></h4>
            <pre>
{""}
{"mkTxnRegisteringNode(this: "}<a href="#NeighborhoodController">{"NeighborhoodController"}</a>{", nodeReg: "}<a href="#minimalNeighborhoodData">{"minimalNeighborhoodData"}</a>{"): "}<a href="#Promise">{"Promise"}</a>{"<"}<a href="#StellarTxnContext">{"StellarTxnContext"}</a>{"<import(\"@donecollectively/stellar-contracts\")."}<a href="#anyState">{"anyState"}</a>{">>"}{";"}
            </pre>
