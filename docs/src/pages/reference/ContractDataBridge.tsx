        ...
        <div>
         ...
         <p>
            <b>Instance methods: </b>
                    <a href="#readData"><var>readData()</var></a>
        </p>
...
{"static isAbstract: "}{"true | false"}{";"}
    ...
    <div className="prose">
        ...
        <ReactMarkdown>
            ...
            <pre><code lang="typescript">
{"activity: "}<a href="#DataBridge">{"DataBridge"}</a>{";"}
            </code></pre>
...
<div className="prose">
        ...
        <ReactMarkdown>
            ...
            <pre><code lang="typescript">
{"datum: "}<a href="#DataBridge">{"DataBridge"}</a>{" | undefined"}{";"}
            </code></pre>
...
<div className="prose">
        ...
        <ReactMarkdown>
            ...
            <pre><code lang="typescript">
{"readDatum: "}<a href="#readsUplcData">{"readsUplcData"}</a>{"<any> | undefined"}{";"}
            </code></pre>
...
<div className="prose">
        ...
        <ReactMarkdown>
            ...
            <pre><code lang="typescript">
{"reader: "}<a href="#DataBridgeReaderClass">{"DataBridgeReaderClass"}</a>{" | undefined"}{";"}
            </code></pre>
...
<div className="prose">
        ...
        <ReactMarkdown>
            ...
            <pre><code lang="typescript">
{"types: "}<a href="#Record">{"Record"}</a>{"<string, "}<a href="#DataBridge">{"DataBridge"}</a>{" | ((x: any) => "}<a href="#UplcData">{"UplcData"}</a>{")>"}{";"}
            </code></pre>
