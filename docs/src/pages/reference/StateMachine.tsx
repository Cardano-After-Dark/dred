...
export default function DocumentItem() {
        ...
        <div>
            ...
            <p>
                <b>Instance properties: </b>
                                <a href="#_deferredSMAction"><var>_deferredSMAction</var></a>, &nbsp;
                    <a href="#$deferredAction"><var>$deferredAction</var></a>, &nbsp;
                    <a href="#$describeDeferredAction"><var>$describeDeferredAction</var></a>, &nbsp;
                    <a href="#$notifier"><var>$notifier</var></a>, &nbsp;
                    <a href="#$state"><var>$state</var></a>, &nbsp;
                    <a href="#deferredTargetState"><var>deferredTargetState</var></a>, &nbsp;
                    <a href="#destroyed"><var>destroyed</var></a>, &nbsp;
                    <a href="#initialState"><var>initialState</var></a>, &nbsp;
                    <a href="#instanceId"><var>instanceId</var></a>, &nbsp;
                    <a href="#onEntry"><var>onEntry</var></a>, &nbsp;
                    <a href="#stateMachineName"><var>stateMachineName</var></a>, &nbsp;
                    <a href="#transitionTable"><var>transitionTable</var></a>
            </p>
         <p>
            <b>Instance methods: </b>
                    <a href="#$canTransition"><var>$canTransition()</var></a>, &nbsp;
                    <a href="#$deferredState"><var>$deferredState()</var></a>, &nbsp;
                    <a href="#$deferredTransition"><var>$deferredTransition()</var></a>, &nbsp;
                    <a href="#$mkTransition"><var>$mkTransition()</var></a>, &nbsp;
                    <a href="#$transition"><var>$transition()</var></a>, &nbsp;
                    <a href="#delayed"><var>delayed()</var></a>, &nbsp;
                    <a href="#destroy"><var>destroy()</var></a>, &nbsp;
                    <a href="#finishTransition"><var>finishTransition()</var></a>, &nbsp;
                    <a href="#ignoringListenerErrors"><var>ignoringListenerErrors()</var></a>, &nbsp;
                    <a href="#log"><var>log()</var></a>, &nbsp;
                    <a href="#mkTransition"><var>mkTransition()</var></a>, &nbsp;
                    <a href="#notDestroyed"><var>notDestroyed()</var></a>, &nbsp;
                    <a href="#onStateEntered"><var>onStateEntered()</var></a>, &nbsp;
                    <a href="#resetState"><var>resetState()</var></a>, &nbsp;
                    <a href="#transition"><var>transition()</var></a>
        </p>
    ...
    <div className="prose">
        <a id="_deferredSMAction"></a>

            <div>
        <h4 style={{display: "inline-block"}}>    {
              "_deferredSMAction"}&nbsp;&nbsp;</h4>
        <ReactMarkdown>
            {
                ""
            }
...
{"_deferredSMAction?: "}<a href="#DeferredStateMachineAction">{"DeferredStateMachineAction"}</a>{"<this, any>"}{";"}
            </code></pre>
...
<div className="prose">
        <a id="$describeDeferredAction"></a>

            <div>
        <h4 style={{display: "inline-block"}}>   readonly {
              "$describeDeferredAction"}&nbsp;&nbsp;</h4>
        <ReactMarkdown>
            {
                ""
            }
...
<div className="prose">
        ...
        <ReactMarkdown>
            ...
            <pre><code lang="typescript">
{"$notifier: "}<a href="#EventEmitter">{"EventEmitter"}</a>{"<"}<a href="#StateMachineEmitter">{"StateMachineEmitter"}</a>{"<this>>"}{";"}
            </code></pre>
...
<div className="prose">
        <a id="deferredTargetState"></a>

            <div>
        <h4 style={{display: "inline-block"}}>   readonly {
              "deferredTargetState"}&nbsp;&nbsp;</h4>
        <ReactMarkdown>
            {
                ""
            }
...
<div className="prose">
        ...
        <ReactMarkdown>
            ...
            <pre><code lang="typescript">
{"onEntry: "}<a href="#Partial">{"Partial"}</a>{"<{\n        [state in STATES]: () => void;\n    }>"}{";"}
            </code></pre>
...
<div className="prose">
        ...
        <ReactMarkdown>
            ...
            <pre><code lang="typescript">
{"abstract transitionTable: "}<a href="#StateTransitionTable">{"StateTransitionTable"}</a>{"<STATES, TRANSITIONS>"}{";"}
            </code></pre>
...
<div className="prose">
        ...
        <ReactMarkdown>
            {
                "Schedules the completion of a deferred transition, placing the state-machine into the target state.\n\n"
            }
        </ReactMarkdown>
    </div>
...
<p></p>
        ...
        <ReactMarkdown> {
            "\n\nWhen the context of a particular state-transition has a natural affinity to a delayed effect of triggering a state-change (or to re-initiating the current-state), this method can be used to indicate that deferred effect.\n\nThe displayStatus is used to provide transparency about the cause and context of the delayed change-of-state.\n\nThe deferred transition will be cancelled if the promise is cancelled or fails.\n\nA key use-case for this is to allow a transition that can re-trigger the onEntry effects of the current state (or another next state), while remaining cosmetically or semantically in the original state, deferred the deferred entry to the target state; the target state's onEntry hook will then be called after the transition is actually finished.\n\nMeanwhile, there is an explicit block on other state-transitions, and there is an explicit current displayStatus providing strong transparency about the deferred switch to the target state.\n\nAs an example, a kitchen-timer feature on a microwave might (once it finishes its countdown to zero and is done beeping), trigger a `$deferredState(\"idle\", ...)` with a deferred displayStatus of \"timer finished\". It would then move to idle when the Cancel button is pressed. This example differs from that in $deferredTransition(), with the assumption that the kitchen timer doesn't try to bug the user about it being finished, the way the \"doneCooking\" state example describes.\n\n### Return-type notes Note that this type is only valid as the return value of an onTransition callback, and not as a return value of an onEntry hook. In an onEntry hook, call and don't return the $deferredTransition(...).\n"
        }</ReactMarkdown>
            <pre><code lang="typescript">
{"$deferredState(this: "}{"this"}{", transitionName: "}{"TRANSITIONS"}{", targetState: "}{"STATES"}{", displayStatus: "}{"string"}{", promiseOrDelay: "}{"number | "}<a href="#AnyPromise">{"AnyPromise"}</a>{"<any>"}{"): "}<a href="#DeferredState">{"DeferredState"}</a>{"<this>"}{";"}
            </code></pre>
...
<div className="prose">
        <a id="$deferredTransition"></a>

            <div>
        <h4 style={{display: "inline-block"}}>    {
              "$deferredTransition"}()&nbsp;&nbsp;</h4>
        <ReactMarkdown>
            {
...
<p></p>
        ...
        <ReactMarkdown> {
            "\n\nWhen there is a deferred transition, the state-machine will not accept other transitions until the promise resolves one way or the other.\n\nA prime use-case for a deferred transition is for an onEntry hook to defer (with setTimeout()) an unconditional next activity that will be triggered by transitioning to the next state.\n\nThe displayStatus is used to provide transparency about the implied \"activity\" of waiting to trigger the transition. For instance, a \"doneCooking\" state on a microwave might have a displayStatus of \"food is ready\", with a 2m-deferred transition to \"remindingReady\" state, where it beeps three times and returns to doneCooking for further reminders (opening the door or pressing Cancel would interrupt and prevent the deferred transition).\n\n### Return-type notes Note that the returned type is not usable as result of an onTransition hook or onEntry hook. In onTransition, you can return `this.$deferredState(...)`. To use `$deferredTransition(...)` in onEntry, just call it and don't return it.\n"
        }</ReactMarkdown>
            <pre><code lang="typescript">
{"$deferredTransition(this: "}{"this"}{", tn: "}{"TRANSITIONS"}{", displayStatus: "}{"string"}{", promiseOrDelay: "}{"number | "}<a href="#AnyPromise">{"AnyPromise"}</a>{"<any>"}{"): "}<a href="#DeferredTransition">{"DeferredTransition"}</a>{"<this>"}{";"}
            </code></pre>
...
<p></p>
        ...
        <ReactMarkdown> {
            "\n\nthe prefix brings this most common method to the top for autocomplete\n\nthe resulting callback will try to transition the state-machine but can fail if the transition table doesn't permit the named transition at the time of the call.\n\n\n"
        }</ReactMarkdown>
            <pre><code lang="typescript">
{"$mkTransition(tn: "}{"TRANSITIONS"}{"): "}{"() => "}<a href="#Promise">{"Promise"}</a>{"<void>"}{";"}
            </code></pre>
...
<p></p>
        ...
        <ReactMarkdown> {
            "\n\ncan fail if the transition table doesn't permit the named transition while in the current state.\n\nthe prefix brings this most common method to the top for autocomplete\n\n\n"
        }</ReactMarkdown>
            <pre><code lang="typescript">
{"$transition(tn: "}{"TRANSITIONS"}{"): "}<a href="#Promise">{"Promise"}</a>{"<void>"}{";"}
            </code></pre>
...
<div className="prose">
        ...
        <ReactMarkdown>
            ...
            <pre><code lang="typescript">
{"delayed(delay?: "}{"number"}{"): "}<a href="#Promise">{"Promise"}</a>{"<unknown>"}{";"}
            </code></pre>
...
<div className="prose">
        ...
        <ReactMarkdown>
            ...
            <pre><code lang="typescript">
{"finishTransition(tn: "}{"TRANSITIONS"}{", targetState: "}{"STATES"}{", currentState: "}{"string"}{", nextState: "}{"string | false | "}<a href="#DeferredState">{"DeferredState"}</a>{"<this>"}{", error: "}{"string"}{"): "}<a href="#Promise">{"Promise"}</a>{"<void> | undefined"}{";"}
            </code></pre>
...
<div className="prose">
        <a id="ignoringListenerErrors"></a>

            <div>
        <h4 style={{display: "inline-block"}}>    {
              "ignoringListenerErrors"}()&nbsp;&nbsp;</h4>
        <ReactMarkdown>
            {
                ""
            }
