        ...
        <div>
         ...
         <p>
            <b>Instance methods: </b>
                    <a href="#AbstractSettingsForNeighborhood"><var>AbstractSettingsForNeighborhood()</var></a>, &nbsp;
                    <a href="#AnyData"><var>AnyData()</var></a>, &nbsp;
                    <a href="#AppInfo"><var>AppInfo()</var></a>, &nbsp;
                    ...
                    <a href="#FeeSource"><var>FeeSource()</var></a>, &nbsp;
                    ...
                    <a href="#NeighborhoodData"><var>NeighborhoodData()</var></a>, &nbsp;
                    <a href="#NeighborhoodSettings"><var>NeighborhoodSettings()</var></a>, &nbsp;
                    <a href="#NodeOpsInfo"><var>NodeOpsInfo()</var></a>, &nbsp;
                    ...
                    <a href="#RevenueModel"><var>RevenueModel()</var></a>, &nbsp;
                    <a href="#SpendingActivity"><var>SpendingActivity()</var></a>, &nbsp;
                    <a href="#SubscriptionFeeFrequency"><var>SubscriptionFeeFrequency()</var></a>
        </p>
...
{"datum: "}{"(d: "}<a href="#UplcData">{"UplcData"}</a>{") => "}<a href="#Partial">{"Partial"}</a>{"<{\n        Cip68RefToken: "}<a href="#DelegateDatum$Ergo$Cip68RefToken">{"DelegateDatum$Ergo$Cip68RefToken"}</a>{";\n        IsDelegation: "}<a href="#ErgoDelegationDetail">{"ErgoDelegationDetail"}</a>{";\n        capoStoredData: "}<a href="#DelegateDatum$Ergo$capoStoredData">{"DelegateDatum$Ergo$capoStoredData"}</a>{";\n    }>"}{";"}
    ...
    <h3>Instance methods</h3>
        <div className="prose">
        <a id="AbstractSettingsForNeighborhood"></a>

            <div>
        <h4 style={{display: "inline-block"}}>    {
              "AbstractSettingsForNeighborhood"}()&nbsp;&nbsp;</h4>
        <ReactMarkdown>
            {
...
<div className="prose">
        <a id="SubscriptionFeeFrequency"></a>

            <div>
        <h4 style={{display: "inline-block"}}>    {
              "SubscriptionFeeFrequency"}()&nbsp;&nbsp;</h4>
        <ReactMarkdown>
            {
