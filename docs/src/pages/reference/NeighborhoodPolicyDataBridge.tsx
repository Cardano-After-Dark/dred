        ...
        <ReactMarkdown> {
            ...
            <p>
                <b>Instance properties: </b>
                    ...
                    <a href="#ᱺᱺAbstractSettingsForNeighborhoodCast"><var>ᱺᱺAbstractSettingsForNeighborhoodCast</var></a>, &nbsp;
                    <a href="#ᱺᱺAnyDataCast"><var>ᱺᱺAnyDataCast</var></a>, &nbsp;
                    <a href="#ᱺᱺAppInfoCast"><var>ᱺᱺAppInfoCast</var></a>, &nbsp;
                    ...
                    <a href="#ᱺᱺNeighborhoodDataCast"><var>ᱺᱺNeighborhoodDataCast</var></a>, &nbsp;
                    <a href="#ᱺᱺNeighborhoodSettingsCast"><var>ᱺᱺNeighborhoodSettingsCast</var></a>, &nbsp;
                    <a href="#ᱺᱺNodeOpsInfoCast"><var>ᱺᱺNodeOpsInfoCast</var></a>, &nbsp;
...
<div className="prose">
        <a id="ᱺᱺAbstractSettingsForNeighborhoodCast"></a>

            <div>
        <h4 style={{display: "inline-block"}}>    {
              "ᱺᱺAbstractSettingsForNeighborhoodCast"}&nbsp;&nbsp;</h4>
        <ReactMarkdown>
            {
...
<div className="prose">
        <a id="ᱺᱺNeighborhoodDataCast"></a>

            <div>
        <h4 style={{display: "inline-block"}}>    {
              "ᱺᱺNeighborhoodDataCast"}&nbsp;&nbsp;</h4>
        <ReactMarkdown>
            {
                "uses unicode U+1c7a - sorts to the end\n"
            }
...
<div className="prose">
        <a id="ᱺᱺNodeOpsInfoCast"></a>

            <div>
        <h4 style={{display: "inline-block"}}>    {
              "ᱺᱺNodeOpsInfoCast"}&nbsp;&nbsp;</h4>
        <ReactMarkdown>
            {
                "uses unicode U+1c7a - sorts to the end\n"
            }
