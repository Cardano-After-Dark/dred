        ...
        <div>
            ...
            <p>
                <b>Instance properties: </b>
                                <a href="#canBatch"><var>canBatch</var></a>, &nbsp;
                    <a href="#wallet"><var>wallet</var></a>
            </p>
         <p>
            <b>Instance methods: </b>
                    <a href="#signSingleTx"><var>signSingleTx()</var></a>, &nbsp;
                    <a href="#signTx"><var>signTx()</var></a>, &nbsp;
                    <a href="#signTxBatch"><var>signTxBatch()</var></a>
        </p>
...
{"wallet: "}<a href="#Wallet">{"Wallet"}</a>{";"}
    ...
    <h3>Instance methods</h3>
        ...
        <ReactMarkdown>
            ...
            <pre><code lang="typescript">
{"abstract signSingleTx(tx: "}<a href="#Tx">{"Tx"}</a>{"): "}<a href="#Promise">{"Promise"}</a>{"<"}<a href="#Signature">{"Signature"}</a>{"[]>"}{";"}
            </code></pre>
...
<div className="prose">
        ...
        <ReactMarkdown>
            ...
            <pre><code lang="typescript">
{"signTx(txTracker: "}<a href="#TxSubmissionTracker">{"TxSubmissionTracker"}</a>{"): "}<a href="#Promise">{"Promise"}</a>{"<void | "}<a href="#Signature">{"Signature"}</a>{"[]>"}{";"}
            </code></pre>
...
<p></p>
        ...
        <ReactMarkdown> {
            "\n\nimplements a fallback for strategies that don't support batching\n\nYou must override this method if your wallet can batch sign. Also, set canBatch = true.\n\nAdds the signatures to the txns and also returns the signatures in case that's helpful.\n"
        }</ReactMarkdown>
            <pre><code lang="typescript">
{"signTxBatch(batch: "}<a href="#BatchSubmitController">{"BatchSubmitController"}</a>{"): "}<a href="#Promise">{"Promise"}</a>{"<(undefined | "}<a href="#Signature">{"Signature"}</a>{"[])[]>"}{";"}
            </code></pre>
