        ...
        <div>
            ...
            <p>
                <b>Instance properties: </b>
                                <a href="#didStart"><var>didStart</var></a>, &nbsp;
                    <a href="#formattedHistory"><var>formattedHistory</var></a>, &nbsp;
                    <a href="#history"><var>history</var></a>, &nbsp;
                    <a href="#isMine"><var>isMine</var></a>, &nbsp;
                    <a href="#lastMessage"><var>lastMessage</var></a>, &nbsp;
                    <a href="#lastReason"><var>lastReason</var></a>, &nbsp;
                    <a href="#lines"><var>lines</var></a>, &nbsp;
                    <a href="#toggler"><var>toggler</var></a>
            </p>
         <p>
            <b>Instance methods: </b>
                    <a href="#finish"><var>finish()</var></a>, &nbsp;
                    <a href="#flush"><var>flush()</var></a>, &nbsp;
                    <a href="#flushError"><var>flushError()</var></a>, &nbsp;
                    <a href="#flushLines"><var>flushLines()</var></a>, &nbsp;
                    <a href="#fullFormattedHistory"><var>fullFormattedHistory()</var></a>, &nbsp;
                    <a href="#fullHistory"><var>fullHistory()</var></a>, &nbsp;
                    <a href="#logError"><var>logError()</var></a>, &nbsp;
                    <a href="#logPrint"><var>logPrint()</var></a>, &nbsp;
                    <a href="#reset"><var>reset()</var></a>, &nbsp;
                    <a href="#resetDots"><var>resetDots()</var></a>, &nbsp;
                    <a href="#showDot"><var>showDot()</var></a>, &nbsp;
                    <a href="#toggleDots"><var>toggleDots()</var></a>
        </p>
...
<div className="prose">
        <a id="fullFormattedHistory"></a>

            <div>
        <h4 style={{display: "inline-block"}}>    {
              "fullFormattedHistory"}()&nbsp;&nbsp;</h4>
        <ReactMarkdown>
            {
                ""
            }
...
<div className="prose">
        ...
        <ReactMarkdown>
            ...
            <pre><code lang="typescript">
{"logError(message: "}{"string"}{", stack?: "}<a href="#Site">{"Site"}</a>{"): "}{"void"}{";"}
            </code></pre>
...
<div className="prose">
        ...
        <ReactMarkdown>
            ...
            <pre><code lang="typescript">
{"logPrint(message: "}{"string"}{", site?: "}<a href="#Site">{"Site"}</a>{"): "}{"this"}{";"}
            </code></pre>
