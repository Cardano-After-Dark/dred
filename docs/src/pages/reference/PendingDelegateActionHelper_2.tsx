...
export default function DocumentItem() {
    return (
        <div>
                <h2>PendingDelegateActionHelper_2</h2>
                    <ReactMarkdown>
                        {
        ...
        <ReactMarkdown> {
            ...
            <p>
                <b>Instance properties: </b>
                                <a href="#$seeded$Add"><var>$seeded$Add</var></a>, &nbsp;
                    <a href="#$seeded$Replace"><var>$seeded$Replace</var></a>, &nbsp;
                    <a href="#Remove"><var>Remove</var></a>
            </p>
         <p>
            <b>Instance methods: </b>
                    <a href="#Add"><var>Add()</var></a>, &nbsp;
                    <a href="#Add"><var>Add()</var></a>, &nbsp;
                    <a href="#Replace"><var>Replace()</var></a>, &nbsp;
                    <a href="#Replace"><var>Replace()</var></a>
        </p>
...
<p></p>
            ...
            <pre><code lang="typescript">
{"Add(fields: "}<a href="#PendingDelegateAction$AddLike_2">{"PendingDelegateAction$AddLike_2"}</a>{" | {\n        seed: "}<a href="#TxOutputId">{"TxOutputId"}</a>{" | string;\n        purpose: string;\n        idPrefix: string;\n    }"}{"): "}<a href="#UplcData">{"UplcData"}</a>{";"}
            </code></pre>
...
<p></p>
            ...
            <pre><code lang="typescript">
{"Replace(fields: "}<a href="#PendingDelegateAction$ReplaceLike_2">{"PendingDelegateAction$ReplaceLike_2"}</a>{" | {\n        seed: "}<a href="#TxOutputId">{"TxOutputId"}</a>{" | string;\n        purpose: string;\n        idPrefix: string;\n        replacesDgt: "}<a href="#AssetClass">{"AssetClass"}</a>{" | string | [string | "}<a href="#MintingPolicyHash">{"MintingPolicyHash"}</a>{" | number[], string | number[]] | {\n            mph: "}<a href="#MintingPolicyHash">{"MintingPolicyHash"}</a>{" | string | number[];\n            tokenName: string | number[];\n        };\n    }"}{"): "}<a href="#UplcData">{"UplcData"}</a>{";"}
            </code></pre>
