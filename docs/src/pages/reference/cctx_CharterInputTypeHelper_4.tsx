...
export default function DocumentItem() {
    return (
        <div>
            <h2>cctx_CharterInputTypeHelper_4</h2>
...
{"ᱺᱺcast: "}<a href="#Cast">{"Cast"}</a>{"<"}<a href="#cctx_CharterInputType">{"cctx_CharterInputType"}</a>{", "}<a href="#Partial">{"Partial"}</a>{"<{\n        Unk: "}<a href="#tagOnly">{"tagOnly"}</a>{";\n        RefInput: "}<a href="#cctx_CharterInputType$RefInputLike">{"cctx_CharterInputType$RefInputLike"}</a>{";\n        Input: "}<a href="#cctx_CharterInputType$InputLike">{"cctx_CharterInputType$InputLike"}</a>{";\n    }>>"}{";"}
            </pre>
