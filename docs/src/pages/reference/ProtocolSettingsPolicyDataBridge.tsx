...
export default function DocumentItem() {
    return (
        <div>
                <h2>ProtocolSettingsPolicyDataBridge</h2>
                    <ReactMarkdown>
                        {
        ...
        <ReactMarkdown> {
            ...
            <p>
                <b>Instance properties: </b>
                    ...
                    <a href="#ᱺᱺNeighborhoodSettingsCast"><var>ᱺᱺNeighborhoodSettingsCast</var></a>, &nbsp;
                    ...
                    <a href="#ᱺᱺProtocolSettingsCast"><var>ᱺᱺProtocolSettingsCast</var></a>, &nbsp;
...
<div className="prose">
        ...
        <ReactMarkdown>
            ...
            <pre><code lang="typescript">
{"reader: "}<a href="#ProtocolSettingsPolicyDataBridgeReader">{"ProtocolSettingsPolicyDataBridgeReader"}</a>{";"}
            </code></pre>
...
<div className="prose">
        <a id="ᱺᱺNeighborhoodSettingsCast"></a>

            <div>
        <h4 style={{display: "inline-block"}}>    {
              "ᱺᱺNeighborhoodSettingsCast"}&nbsp;&nbsp;</h4>
        <ReactMarkdown>
            {
                "uses unicode U+1c7a - sorts to the end\n"
            }
...
<div className="prose">
        <a id="ᱺᱺProtocolSettingsCast"></a>

            <div>
        <h4 style={{display: "inline-block"}}>    {
              "ᱺᱺProtocolSettingsCast"}&nbsp;&nbsp;</h4>
        <ReactMarkdown>
            {
                "uses unicode U+1c7a - sorts to the end\n"
            }
...
<p></p>
            ...
            <pre><code lang="typescript">
{"ᱺᱺProtocolSettingsCast: "}<a href="#Cast">{"Cast"}</a>{"<"}<a href="#ProtocolSettings">{"ProtocolSettings"}</a>{", "}<a href="#ProtocolSettingsLike">{"ProtocolSettingsLike"}</a>{">"}{";"}
            </code></pre>
