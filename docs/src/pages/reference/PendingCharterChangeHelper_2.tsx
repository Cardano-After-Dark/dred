...
export default function DocumentItem() {
    return (
        <div>
                <h2>PendingCharterChangeHelper_2</h2>
                    <ReactMarkdown>
                        {
        ...
        <ReactMarkdown> {
         ...
         <p>
            <b>Instance methods: </b>
                    <a href="#delegateChange"><var>delegateChange()</var></a>, &nbsp;
                    <a href="#otherManifestChange"><var>otherManifestChange()</var></a>
        </p>
...
<div className="prose">
        <a id="otherManifestChange"></a>

            <div>
        <h4 style={{display: "inline-block"}}>    {
              "otherManifestChange"}()&nbsp;&nbsp;</h4>
        <ReactMarkdown>
            {
...
<p></p>
        ...
        <ReactMarkdown> {
            ...
            <pre><code lang="typescript">
{"otherManifestChange(fields: "}<a href="#PendingCharterChange$otherManifestChangeLike_2">{"PendingCharterChange$otherManifestChangeLike_2"}</a>{" | {\n        activity: "}<a href="#ManifestActivityLike_2">{"ManifestActivityLike_2"}</a>{";\n        remainingDelegateValidations: "}<a href="#Array">{"Array"}</a>{"<"}<a href="#DelegateRoleLike_2">{"DelegateRoleLike_2"}</a>{">;\n    }"}{"): "}<a href="#UplcData">{"UplcData"}</a>{";"}
            </code></pre>
