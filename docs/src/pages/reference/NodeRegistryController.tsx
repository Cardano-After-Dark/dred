...
<div className="prose">
        ...
        <ReactMarkdown>
            ...
            <pre><code lang="typescript">
{"mkTxnRegisteringNode(this: "}<a href="#NodeRegistryController">{"NodeRegistryController"}</a>{", nodeReg: "}<a href="#minimalNodeRegistrationData">{"minimalNodeRegistrationData"}</a>{"): "}<a href="#Promise">{"Promise"}</a>{"<"}<a href="#StellarTxnContext">{"StellarTxnContext"}</a>{"<"}<a href="#anyState">{"anyState"}</a>{">>"}{";"}
            </code></pre>
...
<div className="prose">
        ...
        <ReactMarkdown>
            ...
            <pre><code lang="typescript">
{"mkTxnUpdatingNodeRegistration(txnName: "}{"string"}{", item: "}<a href="#FoundDatumUtxo">{"FoundDatumUtxo"}</a>{"<"}<a href="#NodeRegistrationData">{"NodeRegistrationData"}</a>{", any>"}{", options: "}<a href="#DgDataUpdateOptions">{"DgDataUpdateOptions"}</a>{"<"}<a href="#NodeRegistrationDataLike">{"NodeRegistrationDataLike"}</a>{">"}{", tcx?: "}<a href="#StellarTxnContext">{"StellarTxnContext"}</a>{"<"}<a href="#anyState">{"anyState"}</a>{"> | undefined"}{"): "}<a href="#Promise">{"Promise"}</a>{"<"}<a href="#StellarTxnContext">{"StellarTxnContext"}</a>{"<"}<a href="#anyState">{"anyState"}</a>{">>"}{";"}
            </code></pre>
