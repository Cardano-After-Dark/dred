        ...
        <div>
            ...
            <p>
                <b>Instance properties: </b>
                                <a href="#_current"><var>_current</var></a>, &nbsp;
                    <a href="#$notifier"><var>$notifier</var></a>, &nbsp;
                    <a href="#current"><var>current</var></a>, &nbsp;
                    <a href="#previous"><var>previous</var></a>, &nbsp;
         ...
         <p>
            <b>Instance methods: </b>
                    <a href="#canRotate"><var>canRotate()</var></a>, &nbsp;
                    <a href="#rotate"><var>rotate()</var></a>
        </p>
...
{"_current?: "}<a href="#BatchSubmitController">{"BatchSubmitController"}</a>{";"}
            </code></pre>
...
<div className="prose">
        ...
        <ReactMarkdown>
            ...
            <pre><code lang="typescript">
{"$notifier: "}<a href="#EventEmitter">{"EventEmitter"}</a>{"<"}<a href="#TxBatcherChanges">{"TxBatcherChanges"}</a>{", any>"}{";"}
            </code></pre>
...
<div className="prose">
        ...
        <ReactMarkdown>
            ...
            <pre><code lang="typescript">
{"get current(): "}<a href="#BatchSubmitController">{"BatchSubmitController"}</a>{";"}
            </code></pre>
...
<div className="prose">
        ...
        <ReactMarkdown>
            ...
            <pre><code lang="typescript">
{"previous?: "}<a href="#BatchSubmitController">{"BatchSubmitController"}</a>{";"}
            </code></pre>
...
<div className="prose">
        ...
        <ReactMarkdown>
            ...
            <pre><code lang="typescript">
{"rotate(chainBuilder?: "}<a href="#TxChainBuilder">{"TxChainBuilder"}</a>{"): "}{"void"}{";"}
            </code></pre>
