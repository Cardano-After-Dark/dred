...
export default function DocumentItem() {
    return (
        <div>
                <h2>DredNodeRegistryPolicyDataBridge</h2>
                    <ReactMarkdown>
                        {
        ...
        <ReactMarkdown> {
            ...
            <p>
                <b>Instance properties: </b>
                    ...
                    <a href="#ᱺᱺAbstractSettingsForNodeOperatorCast"><var>ᱺᱺAbstractSettingsForNodeOperatorCast</var></a>, &nbsp;
                    ...
                    <a href="#ᱺᱺDgDataDetailsCast"><var>ᱺᱺDgDataDetailsCast</var></a>, &nbsp;
                    <a href="#ᱺᱺNodeOperatorSettingsCast"><var>ᱺᱺNodeOperatorSettingsCast</var></a>, &nbsp;
                    <a href="#ᱺᱺNodeRegistrationDataCast"><var>ᱺᱺNodeRegistrationDataCast</var></a>, &nbsp;
...
<div className="prose">
        ...
        <ReactMarkdown>
            ...
            <pre><code lang="typescript">
{"reader: "}<a href="#DredNodeRegistryPolicyDataBridgeReader">{"DredNodeRegistryPolicyDataBridgeReader"}</a>{";"}
            </code></pre>
...
<div className="prose">
        <a id="ᱺᱺAbstractSettingsForNodeOperatorCast"></a>

            <div>
        <h4 style={{display: "inline-block"}}>    {
              "ᱺᱺAbstractSettingsForNodeOperatorCast"}&nbsp;&nbsp;</h4>
        <ReactMarkdown>
            {
...
<p></p>
            ...
            <pre><code lang="typescript">
{"ᱺᱺAbstractSettingsForNodeOperatorCast: "}<a href="#Cast">{"Cast"}</a>{"<"}<a href="#AbstractSettingsForNodeOperator">{"AbstractSettingsForNodeOperator"}</a>{", "}<a href="#AbstractSettingsForNodeOperatorLike">{"AbstractSettingsForNodeOperatorLike"}</a>{">"}{";"}
            </code></pre>
...
<div className="prose">
        <a id="ᱺᱺDgDataDetailsCast"></a>

            <div>
        <h4 style={{display: "inline-block"}}>    {
              "ᱺᱺDgDataDetailsCast"}&nbsp;&nbsp;</h4>
        <ReactMarkdown>
            {
                "uses unicode U+1c7a - sorts to the end\n"
            }
...
<div className="prose">
        <a id="ᱺᱺNodeOperatorSettingsCast"></a>

            <div>
        <h4 style={{display: "inline-block"}}>    {
              "ᱺᱺNodeOperatorSettingsCast"}&nbsp;&nbsp;</h4>
        <ReactMarkdown>
            {
                "uses unicode U+1c7a - sorts to the end\n"
            }
...
<p></p>
            ...
            <pre><code lang="typescript">
{"ᱺᱺNodeOperatorSettingsCast: "}<a href="#Cast">{"Cast"}</a>{"<"}<a href="#NodeOperatorSettings">{"NodeOperatorSettings"}</a>{", "}<a href="#NodeOperatorSettingsLike">{"NodeOperatorSettingsLike"}</a>{">"}{";"}
            </code></pre>
...
<div className="prose">
        <a id="ᱺᱺNodeRegistrationDataCast"></a>

            <div>
        <h4 style={{display: "inline-block"}}>    {
              "ᱺᱺNodeRegistrationDataCast"}&nbsp;&nbsp;</h4>
        <ReactMarkdown>
            {
                "uses unicode U+1c7a - sorts to the end\n"
            }
...
<p></p>
            ...
            <pre><code lang="typescript">
{"ᱺᱺNodeRegistrationDataCast: "}<a href="#Cast">{"Cast"}</a>{"<"}<a href="#NodeRegistrationData">{"NodeRegistrationData"}</a>{", "}<a href="#NodeRegistrationDataLike">{"NodeRegistrationDataLike"}</a>{">"}{";"}
            </code></pre>
