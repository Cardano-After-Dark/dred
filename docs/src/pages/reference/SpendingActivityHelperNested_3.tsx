...
export default function DocumentItem() {
    return (
        <div>
                <h2>SpendingActivityHelperNested_3</h2>
                    <ReactMarkdown>
                        {
        ...
        <ReactMarkdown> {
         ...
         <p>
            <b>Instance methods: </b>
                    <a href="#UpdatingRecord"><var>UpdatingRecord()</var></a>
        </p>
...
{"UpdatingRecord(id: "}{"number[]"}{"): "}<a href="#isActivity">{"isActivity"}</a>{";"}
            </code></pre>
