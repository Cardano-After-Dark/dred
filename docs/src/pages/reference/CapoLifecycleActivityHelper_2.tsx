...
export default function DocumentItem() {
    return (
        <div>
                <h2>CapoLifecycleActivityHelper_2</h2>
                    <ReactMarkdown>
                        {
...
<p></p>
        ...
        <ReactMarkdown> {
            ...
            <pre><code lang="typescript">
{"get commitPendingChanges(): "}<a href="#UplcData">{"UplcData"}</a>{";"}
            </code></pre>
...
<p></p>
        ...
        <ReactMarkdown> {
            ...
            <pre><code lang="typescript">
{"get queuePendingChange(): "}<a href="#UplcData">{"UplcData"}</a>{";"}
            </code></pre>
...
<p></p>
            ...
            <pre><code lang="typescript">
{"get removePendingChange(): "}<a href="#DelegateRoleHelperNested_2">{"DelegateRoleHelperNested_2"}</a>{";"}
            </code></pre>
...
<p></p>
            ...
            <pre><code lang="typescript">
{"get updatingManifest(): "}<a href="#ManifestActivityHelperNested_2">{"ManifestActivityHelperNested_2"}</a>{";"}
            </code></pre>
...
<p></p>
            ...
            <pre><code lang="typescript">
{"CreatingDelegate(fields: "}<a href="#CapoLifecycleActivity$CreatingDelegateLike_2">{"CapoLifecycleActivity$CreatingDelegateLike_2"}</a>{" | {\n        seed: "}<a href="#TxOutputId">{"TxOutputId"}</a>{" | string;\n        purpose: string;\n    }"}{"): "}<a href="#UplcData">{"UplcData"}</a>{";"}
            </code></pre>
...
<p></p>
            ...
            <pre><code lang="typescript">
{"forcingNewMintDelegate(fields: "}<a href="#CapoLifecycleActivity$forcingNewMintDelegateLike_2">{"CapoLifecycleActivity$forcingNewMintDelegateLike_2"}</a>{" | {\n        seed: "}<a href="#TxOutputId">{"TxOutputId"}</a>{" | string;\n        purpose: string;\n    }"}{"): "}<a href="#UplcData">{"UplcData"}</a>{";"}
            </code></pre>
...
<p></p>
            ...
            <pre><code lang="typescript">
{"forcingNewSpendDelegate(fields: "}<a href="#CapoLifecycleActivity$forcingNewSpendDelegateLike_2">{"CapoLifecycleActivity$forcingNewSpendDelegateLike_2"}</a>{" | {\n        seed: "}<a href="#TxOutputId">{"TxOutputId"}</a>{" | string;\n        purpose: string;\n    }"}{"): "}<a href="#UplcData">{"UplcData"}</a>{";"}
            </code></pre>
