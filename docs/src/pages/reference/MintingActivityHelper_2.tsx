...
export default function DocumentItem() {
        ...
        <ReactMarkdown> {
            ...
            <p>
                <b>Instance properties: </b>
                                <a href="#SampleMintingActivity"><var>SampleMintingActivity</var></a>
            </p>
         <p>
            <b>Instance methods: </b>
                    <a href="#MintingFungibleTokens"><var>MintingFungibleTokens()</var></a>
        </p>
    ...
    <div className="prose">
        <a id="SampleMintingActivity"></a>

            <div>
        <h4 style={{display: "inline-block"}}>   readonly {
              "SampleMintingActivity"}&nbsp;&nbsp;</h4>
        <ReactMarkdown>
            {
...
{"get SampleMintingActivity(): "}<a href="#UplcData">{"UplcData"}</a>{";"}
            </code></pre>
    ...
    <h3>Instance methods</h3>
        <div className="prose">
        <a id="MintingFungibleTokens"></a>

            <div>
        <h4 style={{display: "inline-block"}}>    {
              "MintingFungibleTokens"}()&nbsp;&nbsp;</h4>
        <ReactMarkdown>
            {
...
<p></p>
            ...
            <pre><code lang="typescript">
{"MintingFungibleTokens(tokenName: "}{"number[]"}{"): "}<a href="#UplcData">{"UplcData"}</a>{";"}
            </code></pre>
