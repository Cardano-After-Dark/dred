        ...
        <div>
            ...
            <p>
                <b>Instance properties: </b>
                    ...
                    <a href="#isBuilt"><var>isBuilt</var></a>, &nbsp;
                    <a href="#isSigned"><var>isSigned</var></a>, &nbsp;
                    ...
                    <a href="#txLabel"><var>txLabel</var></a>, &nbsp;
                    <a href="#txSubmitters"><var>txSubmitters</var></a>
            </p>
         <p>
            <b>Instance methods: </b>
                    <a href="#$didSignTx"><var>$didSignTx()</var></a>, &nbsp;
                    <a href="#$signAndSubmit"><var>$signAndSubmit()</var></a>, &nbsp;
                    <a href="#$startSubmitting"><var>$startSubmitting()</var></a>, &nbsp;
                    <a href="#destroy"><var>destroy()</var></a>, &nbsp;
                    <a href="#resetState"><var>resetState()</var></a>, &nbsp;
                    <a href="#update"><var>update()</var></a>, &nbsp;
                    <a href="#updateSubmitterState"><var>updateSubmitterState()</var></a>
        </p>
...
<div className="prose">
        ...
        <ReactMarkdown>
            ...
            <pre><code lang="typescript">
{"submitters: "}<a href="#namedSubmitters">{"namedSubmitters"}</a>{";"}
            </code></pre>
...
<div className="prose">
        ...
        <ReactMarkdown>
            ...
            <pre><code lang="typescript">
{"transitionTable: "}<a href="#StateTransitionTable">{"StateTransitionTable"}</a>{"<"}<a href="#SubmissionsStates">{"SubmissionsStates"}</a>{", "}<a href="#SubmissionsTransitions">{"SubmissionsTransitions"}</a>{">"}{";"}
            </code></pre>
...
<div className="prose">
        ...
        <ReactMarkdown>
            ...
            <pre><code lang="typescript">
{"txd: "}<a href="#TxDescription">{"TxDescription"}</a>{"<any, any>"}{";"}
            </code></pre>
...
<div className="prose">
        ...
        <ReactMarkdown>
            ...
            <pre><code lang="typescript">
{"txSubmitters: "}<a href="#Record">{"Record"}</a>{"<string, "}<a href="#TxSubmitMgr">{"TxSubmitMgr"}</a>{">"}{";"}
            </code></pre>
...
<p></p>
        ...
        <ReactMarkdown> {
            "\n\nthis should be triggered by the batch-controller's tx-submit strategy either in bulk or on individual txns\n\n\n"
        }</ReactMarkdown>
            <pre><code lang="typescript">
{"$didSignTx(): "}{"void"}{";"}
            </code></pre>
...
<div className="prose">
        ...
        <ReactMarkdown>
            ...
            <pre><code lang="typescript">
{"$signAndSubmit(): "}<a href="#Promise">{"Promise"}</a>{"<void>"}{";"}
            </code></pre>
...
<div className="prose">
        ...
        <ReactMarkdown>
            ...
            <pre><code lang="typescript">
{"update(txd: "}<a href="#TxDescription">{"TxDescription"}</a>{"<any, any>"}{", transition?: "}<a href="#SubmissionsTransitions">{"SubmissionsTransitions"}</a>{"): "}{"void"}{";"}
            </code></pre>
...
<div className="prose">
        <a id="updateSubmitterState"></a>

            <div>
        <h4 style={{display: "inline-block"}}>    {
              "updateSubmitterState"}()&nbsp;&nbsp;</h4>
        <ReactMarkdown>
            {
...
<p></p>
        ...
        <ReactMarkdown> {
            "\n\nCalled every time one of the submit-managers' state is changed. Based on the status of that submitter, the tx-tracker's state is updated.\n\nIf there is a failure detected in the submit-manager, the other submit managers are notified of the problem, which typically triggers them to re-confirm and/or re-submit the transaction to the network, to recover from txns that might otherwise have been dropped due to a slot/height battle.\n\nSwitches the tx-tracker's state to match the aggregated state of its submitters. This aggregated state is suitable for presenting to the user\n"
        }</ReactMarkdown>
            <pre><code lang="typescript">
{"updateSubmitterState(name: "}{"string"}{", mgr: "}<a href="#TxSubmitMgr">{"TxSubmitMgr"}</a>{"): "}{"void"}{";"}
            </code></pre>
