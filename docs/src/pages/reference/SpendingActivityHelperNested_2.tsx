...
export default function DocumentItem() {
    return (
        <div>
                <h2>SpendingActivityHelperNested_2</h2>
                    <ReactMarkdown>
                        {
        ...
        <ReactMarkdown> {
         ...
         <p>
            <b>Instance methods: </b>
                    <a href="#SampleSpendingActivity"><var>SampleSpendingActivity()</var></a>
        </p>
    ...
    <h3>Instance methods</h3>
        <div className="prose">
        <a id="SampleSpendingActivity"></a>

            <div>
        <h4 style={{display: "inline-block"}}>    {
              "SampleSpendingActivity"}()&nbsp;&nbsp;</h4>
        <ReactMarkdown>
            {
...
{"SampleSpendingActivity(recId: "}{"number[]"}{"): "}<a href="#isActivity">{"isActivity"}</a>{";"}
            </code></pre>
