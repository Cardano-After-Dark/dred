...
export default function DocumentItem() {
        ...
        <ReactMarkdown> {
            ...
            <p>
                <b>Instance properties: </b>
                                <a href="#$seeded$CreatingRecord"><var>$seeded$CreatingRecord</var></a>
            </p>
         <p>
            <b>Instance methods: </b>
                    <a href="#CreatingRecord"><var>CreatingRecord()</var></a>
        </p>
    ...
    <div className="prose">
        <a id="$seeded$CreatingRecord"></a>

            <div>
        <h4 style={{display: "inline-block"}}>   readonly {
              "$seeded$CreatingRecord"}&nbsp;&nbsp;</h4>
        <ReactMarkdown>
            {
...
{"get $seeded$CreatingRecord(): "}{"import(\"@donecollectively/stellar-contracts\")."}<a href="#SeedActivity">{"SeedActivity"}</a>{"<(thingWithSeed: "}<a href="#hasSeed">{"hasSeed"}</a>{" | "}<a href="#TxOutputId">{"TxOutputId"}</a>{" | string) => "}<a href="#UplcData">{"UplcData"}</a>{">"}{";"}
            </code></pre>
...
<p></p>
        ...
        <ReactMarkdown> {
            ...
            <pre><code lang="typescript">
{"CreatingRecord(thingWithSeed: "}<a href="#hasSeed">{"hasSeed"}</a>{" | "}<a href="#TxOutputId">{"TxOutputId"}</a>{" | string"}{"): "}<a href="#UplcData">{"UplcData"}</a>{";"}
            </code></pre>
