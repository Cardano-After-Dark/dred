...
export default function DocumentItem() {
    return (
        <div>
                <h2>MintingActivityHelperNested</h2>
                    <ReactMarkdown>
                        {
        ...
        <ReactMarkdown> {
            ...
            <p>
                <b>Instance properties: </b>
                                <a href="#$seeded$_placeholder1MA"><var>$seeded$_placeholder1MA</var></a>
            </p>
         <p>
            <b>Instance methods: </b>
                    <a href="#_placeholder1MA"><var>_placeholder1MA()</var></a>
        </p>
    ...
    <div className="prose">
        <a id="$seeded$_placeholder1MA"></a>

            <div>
        <h4 style={{display: "inline-block"}}>   readonly {
              "$seeded$_placeholder1MA"}&nbsp;&nbsp;</h4>
        <ReactMarkdown>
            {
...
{"get $seeded$_placeholder1MA(): "}<a href="#SeedActivity">{"SeedActivity"}</a>{"<(thingWithSeed: "}<a href="#hasSeed">{"hasSeed"}</a>{" | "}<a href="#TxOutputId">{"TxOutputId"}</a>{" | string) => "}<a href="#isActivity">{"isActivity"}</a>{">"}{";"}
    ...
    <h3>Instance methods</h3>
        ...
        <ReactMarkdown>
            {
                "generates isActivity/redeemer wrapper with UplcData for ***\"UnspecializedDelegate::MintingActivity._placeholder1MA\"***, given a transaction-context (or direct arg) with a ***seed utxo***\n\n"
            }
        </ReactMarkdown>
    </div>
