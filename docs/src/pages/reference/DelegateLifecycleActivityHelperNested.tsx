...
export default function DocumentItem() {
    return (
        <div>
                <h2>DelegateLifecycleActivityHelperNested</h2>
                    <ReactMarkdown>
                        {
        ...
        <ReactMarkdown> {
            ...
            <p>
                <b>Instance properties: </b>
                                <a href="#$seeded$ReplacingMe"><var>$seeded$ReplacingMe</var></a>, &nbsp;
                    <a href="#Retiring"><var>Retiring</var></a>, &nbsp;
                    <a href="#ValidatingSettings"><var>ValidatingSettings</var></a>
            </p>
         <p>
            <b>Instance methods: </b>
                    <a href="#ReplacingMe"><var>ReplacingMe()</var></a>, &nbsp;
                    <a href="#ReplacingMe"><var>ReplacingMe()</var></a>
        </p>
    ...
    <div className="prose">
        <a id="$seeded$ReplacingMe"></a>

            <div>
        <h4 style={{display: "inline-block"}}>    {
              "$seeded$ReplacingMe"}&nbsp;&nbsp;</h4>
        <ReactMarkdown>
            {
...
<div className="prose">
        <a id="ValidatingSettings"></a>

            <div>
        <h4 style={{display: "inline-block"}}>   readonly {
              "ValidatingSettings"}&nbsp;&nbsp;</h4>
        <ReactMarkdown>
            {
