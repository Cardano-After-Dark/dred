...
export default function DocumentItem() {
        ...
        <ReactMarkdown> {
            ...
            <p>
                <b>Instance properties: </b>
                                <a href="#$seeded$CreatingDelegatedData"><var>$seeded$CreatingDelegatedData</var></a>, &nbsp;
                    <a href="#BurningActivities"><var>BurningActivities</var></a>, &nbsp;
                    <a href="#CapoLifecycleActivities"><var>CapoLifecycleActivities</var></a>, &nbsp;
                    <a href="#DelegateLifecycleActivities"><var>DelegateLifecycleActivities</var></a>, &nbsp;
                    <a href="#MintingActivities"><var>MintingActivities</var></a>, &nbsp;
                    <a href="#SpendingActivities"><var>SpendingActivities</var></a>
            </p>
         <p>
            <b>Instance methods: </b>
                    <a href="#CreatingDelegatedData"><var>CreatingDelegatedData()</var></a>, &nbsp;
                    <a href="#CreatingDelegatedData"><var>CreatingDelegatedData()</var></a>, &nbsp;
                    <a href="#DeletingDelegatedData"><var>DeletingDelegatedData()</var></a>, &nbsp;
                    <a href="#MultipleDelegateActivities"><var>MultipleDelegateActivities()</var></a>, &nbsp;
                    <a href="#UpdatingDelegatedData"><var>UpdatingDelegatedData()</var></a>
        </p>
    ...
    <div className="prose">
        <a id="$seeded$CreatingDelegatedData"></a>

            <div>
        <h4 style={{display: "inline-block"}}>    {
              "$seeded$CreatingDelegatedData"}&nbsp;&nbsp;</h4>
        <ReactMarkdown>
            {
...
<div className="prose">
        <a id="BurningActivities"></a>

            <div>
        <h4 style={{display: "inline-block"}}>   readonly {
              "BurningActivities"}&nbsp;&nbsp;</h4>
        <ReactMarkdown>
            {
...
<div className="prose">
        <a id="CapoLifecycleActivities"></a>

            <div>
        <h4 style={{display: "inline-block"}}>   readonly {
              "CapoLifecycleActivities"}&nbsp;&nbsp;</h4>
        <ReactMarkdown>
            {
...
<p></p>
            ...
            <pre><code lang="typescript">
{"get CapoLifecycleActivities(): "}<a href="#CapoLifecycleActivityHelperNested_2">{"CapoLifecycleActivityHelperNested_2"}</a>{";"}
            </code></pre>
...
<div className="prose">
        <a id="DelegateLifecycleActivities"></a>

            <div>
        <h4 style={{display: "inline-block"}}>   readonly {
              "DelegateLifecycleActivities"}&nbsp;&nbsp;</h4>
        <ReactMarkdown>
            {
...
<div className="prose">
        <a id="MintingActivities"></a>

            <div>
        <h4 style={{display: "inline-block"}}>   readonly {
              "MintingActivities"}&nbsp;&nbsp;</h4>
        <ReactMarkdown>
            {
...
<div className="prose">
        <a id="SpendingActivities"></a>

            <div>
        <h4 style={{display: "inline-block"}}>   readonly {
              "SpendingActivities"}&nbsp;&nbsp;</h4>
        <ReactMarkdown>
            {
...
{"get SpendingActivities(): "}<a href="#SpendingActivityHelperNested">{"SpendingActivityHelperNested"}</a>{";"}
    ...
    <h3>Instance methods</h3>
        <div className="prose">
        <a id="CreatingDelegatedData"></a>

            <div>
        <h4 style={{display: "inline-block"}}>    {
              "CreatingDelegatedData"}()&nbsp;&nbsp;</h4>
        <ReactMarkdown>
            {
...
<div className="prose">
        <a id="DeletingDelegatedData"></a>

            <div>
        <h4 style={{display: "inline-block"}}>    {
              "DeletingDelegatedData"}()&nbsp;&nbsp;</h4>
        <ReactMarkdown>
            {
...
<div className="prose">
        <a id="MultipleDelegateActivities"></a>

            <div>
        <h4 style={{display: "inline-block"}}>    {
              "MultipleDelegateActivities"}()&nbsp;&nbsp;</h4>
        <ReactMarkdown>
            {
...
<div className="prose">
        <a id="UpdatingDelegatedData"></a>

            <div>
        <h4 style={{display: "inline-block"}}>    {
              "UpdatingDelegatedData"}()&nbsp;&nbsp;</h4>
        <ReactMarkdown>
            {
