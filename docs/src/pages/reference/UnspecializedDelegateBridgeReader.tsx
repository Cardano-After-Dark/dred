...
export default function DocumentItem() {
    return (
        <div>
                <h2>UnspecializedDelegateBridgeReader</h2>
                    <ReactMarkdown>
                        {
                            ""
                        }
...
{"bridge: "}<a href="#UnspecializedDelegateBridge">{"UnspecializedDelegateBridge"}</a>{";"}
            </code></pre>
...
<p></p>
            ...
            <pre><code lang="typescript">
{"AnyData(d: "}<a href="#UplcData">{"UplcData"}</a>{"): "}<a href="#AnyData_2">{"AnyData_2"}</a>{";"}
            </code></pre>
...
<p></p>
            ...
            <pre><code lang="typescript">
{"CapoLifecycleActivity(d: "}<a href="#UplcData">{"UplcData"}</a>{"): "}<a href="#ErgoCapoLifecycleActivity_2">{"ErgoCapoLifecycleActivity_2"}</a>{";"}
            </code></pre>
...
<p></p>
            ...
            <pre><code lang="typescript">
{"CapoManifestEntry(d: "}<a href="#UplcData">{"UplcData"}</a>{"): "}<a href="#CapoManifestEntry_2">{"CapoManifestEntry_2"}</a>{";"}
            </code></pre>
...
<p></p>
            ...
            <pre><code lang="typescript">
{"DelegateRole(d: "}<a href="#UplcData">{"UplcData"}</a>{"): "}<a href="#ErgoDelegateRole_2">{"ErgoDelegateRole_2"}</a>{";"}
            </code></pre>
...
<p></p>
            ...
            <pre><code lang="typescript">
{"DelegationDetail(d: "}<a href="#UplcData">{"UplcData"}</a>{"): "}<a href="#DelegationDetail_2">{"DelegationDetail_2"}</a>{";"}
            </code></pre>
...
<p></p>
            ...
            <pre><code lang="typescript">
{"ManifestActivity(d: "}<a href="#UplcData">{"UplcData"}</a>{"): "}<a href="#ErgoManifestActivity_2">{"ErgoManifestActivity_2"}</a>{";"}
            </code></pre>
...
<p></p>
            ...
            <pre><code lang="typescript">
{"ManifestEntryType(d: "}<a href="#UplcData">{"UplcData"}</a>{"): "}<a href="#ErgoManifestEntryType_2">{"ErgoManifestEntryType_2"}</a>{";"}
            </code></pre>
...
<p></p>
            ...
            <pre><code lang="typescript">
{"PendingCharterChange(d: "}<a href="#UplcData">{"UplcData"}</a>{"): "}<a href="#ErgoPendingCharterChange_2">{"ErgoPendingCharterChange_2"}</a>{";"}
            </code></pre>
...
<p></p>
            ...
            <pre><code lang="typescript">
{"PendingDelegateAction(d: "}<a href="#UplcData">{"UplcData"}</a>{"): "}<a href="#ErgoPendingDelegateAction_2">{"ErgoPendingDelegateAction_2"}</a>{";"}
            </code></pre>
...
<p></p>
            ...
            <pre><code lang="typescript">
{"PendingDelegateChange(d: "}<a href="#UplcData">{"UplcData"}</a>{"): "}<a href="#PendingDelegateChange_2">{"PendingDelegateChange_2"}</a>{";"}
            </code></pre>
...
<p></p>
            ...
            <pre><code lang="typescript">
{"RelativeDelegateLink(d: "}<a href="#UplcData">{"UplcData"}</a>{"): "}<a href="#RelativeDelegateLink_3">{"RelativeDelegateLink_3"}</a>{";"}
            </code></pre>
