...
export default function DocumentItem() {
    return (
        <div>
                <h2>CapoMinterDataBridge</h2>
                    <ReactMarkdown>
                        {
                            "GENERATED data bridge for **CapoMinter** script (defined in class ***CapoMinterBundle***) main: **src/minting/CapoMinter.hl**, project: **stellar-contracts**\n\n"
                        }
                    </ReactMarkdown>
        ...
        <ReactMarkdown> {
            ...
            <p>
                <b>Instance properties: </b>
                    ...
                    <a href="#isAbstract"><var>isAbstract</var></a>, &nbsp;
                    <a href="#MinterActivity"><var>MinterActivity</var></a>, &nbsp;
...
<p></p>
            ...
            <pre><code lang="typescript">
{"activity: "}<a href="#MinterActivityHelper">{"MinterActivityHelper"}</a>{";"}
            </code></pre>
...
<div className="prose">
        ...
        <ReactMarkdown>
            ...
            <pre><code lang="typescript">
{"MinterActivity: "}<a href="#MinterActivityHelper">{"MinterActivityHelper"}</a>{";"}
            </code></pre>
...
<div className="prose">
        ...
        <ReactMarkdown>
            ...
            <pre><code lang="typescript">
{"reader: "}<a href="#CapoMinterDataBridgeReader">{"CapoMinterDataBridgeReader"}</a>{";"}
            </code></pre>
...
<p></p>
            ...
            <pre><code lang="typescript">
{"ᱺᱺRelativeDelegateLinkCast: "}<a href="#Cast">{"Cast"}</a>{"<"}<a href="#RelativeDelegateLink_2">{"RelativeDelegateLink_2"}</a>{", "}<a href="#RelativeDelegateLinkLike_2">{"RelativeDelegateLinkLike_2"}</a>{">"}{";"}
            </code></pre>
