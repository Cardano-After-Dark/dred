        ...
        <ReactMarkdown> {
         ...
         <p>
            <b>Instance methods: </b>
                    <a href="#capoStoredData"><var>capoStoredData()</var></a>, &nbsp;
                    <a href="#Cip68RefToken"><var>Cip68RefToken()</var></a>, &nbsp;
                    <a href="#IsDelegation"><var>IsDelegation()</var></a>
        </p>
