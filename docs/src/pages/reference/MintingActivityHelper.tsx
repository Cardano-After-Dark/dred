...
{"get $seeded$_placeholder1MA(): "}<a href="#SeedActivity">{"SeedActivity"}</a>{"<(thingWithSeed: "}<a href="#hasSeed">{"hasSeed"}</a>{" | "}<a href="#TxOutputId">{"TxOutputId"}</a>{" | string) => "}<a href="#UplcData">{"UplcData"}</a>{">"}{";"}
            </code></pre>
    ...
    <h3>Instance methods</h3>
        ...
        <ReactMarkdown>
            {
                "generates UplcData for ***\"UnspecializedDelegate::MintingActivity._placeholder1MA\"***, given a transaction-context (or direct arg) with a ***seed utxo***\n\n"
            }
        </ReactMarkdown>
    </div>
...
<p></p>
        ...
        <ReactMarkdown> {
            ...
            <pre><code lang="typescript">
{"_placeholder1MA(thingWithSeed: "}<a href="#hasSeed">{"hasSeed"}</a>{" | "}<a href="#TxOutputId">{"TxOutputId"}</a>{" | string"}{"): "}<a href="#UplcData">{"UplcData"}</a>{";"}
            </code></pre>
