        ...
        <div>
            ...
            <p>
                <b>Instance properties: </b>
                                <a href="#$$statusSummary"><var>$$statusSummary</var></a>, &nbsp;
                    <a href="#$mgrState"><var>$mgrState</var></a>, &nbsp;
                    <a href="#currentSlot"><var>currentSlot</var></a>, &nbsp;
                    <a href="#id"><var>id</var></a>, &nbsp;
                    <a href="#initialState"><var>initialState</var></a>, &nbsp;
                    <a href="#name"><var>name</var></a>, &nbsp;
                    <a href="#network"><var>network</var></a>, &nbsp;
                    <a href="#networkParams"><var>networkParams</var></a>, &nbsp;
                    <a href="#onEntry"><var>onEntry</var></a>, &nbsp;
                    <a href="#pending"><var>pending</var></a>, &nbsp;
                    <a href="#retryIntervals"><var>retryIntervals</var></a>, &nbsp;
                    <a href="#setup"><var>setup</var></a>, &nbsp;
                    <a href="#stateMachineName"><var>stateMachineName</var></a>, &nbsp;
                    <a href="#submitIssue"><var>submitIssue</var></a>, &nbsp;
                    <a href="#submitter"><var>submitter</var></a>, &nbsp;
                    <a href="#transitionTable"><var>transitionTable</var></a>, &nbsp;
                    <a href="#tx"><var>tx</var></a>, &nbsp;
                    <a href="#txd"><var>txd</var></a>, &nbsp;
                    <a href="#txDescription"><var>txDescription</var></a>, &nbsp;
                    <a href="#txId"><var>txId</var></a>
            </p>
         <p>
            <b>Instance methods: </b>
                    <a href="#confirmTx"><var>confirmTx()</var></a>, &nbsp;
                    <a href="#destroy"><var>destroy()</var></a>, &nbsp;
                    <a href="#didConfirm"><var>didConfirm()</var></a>, &nbsp;
                    <a href="#done"><var>done()</var></a>, &nbsp;
                    <a href="#doSubmit"><var>doSubmit()</var></a>, &nbsp;
                    <a href="#firmBackoff"><var>firmBackoff()</var></a>, &nbsp;
                    <a href="#gradualBackoff"><var>gradualBackoff()</var></a>, &nbsp;
                    <a href="#inputUtxosAreResolvable"><var>inputUtxosAreResolvable()</var></a>, &nbsp;
                    <a href="#isExpiryError"><var>isExpiryError()</var></a>, &nbsp;
                    <a href="#isTxExpired"><var>isTxExpired()</var></a>, &nbsp;
                    <a href="#isUnknownUtxoError"><var>isUnknownUtxoError()</var></a>, &nbsp;
                    <a href="#nextStartTime"><var>nextStartTime()</var></a>, &nbsp;
                    <a href="#notConfirmed"><var>notConfirmed()</var></a>, &nbsp;
                    <a href="#nothingPendingAllowed"><var>nothingPendingAllowed()</var></a>, &nbsp;
                    <a href="#notSubmitted"><var>notSubmitted()</var></a>, &nbsp;
                    <a href="#otherSubmitterProblem"><var>otherSubmitterProblem()</var></a>, &nbsp;
                    <a href="#pendingActivity"><var>pendingActivity()</var></a>, &nbsp;
                    <a href="#resetConfirmationStats"><var>resetConfirmationStats()</var></a>, &nbsp;
                    <a href="#resetState"><var>resetState()</var></a>, &nbsp;
                    <a href="#scheduleAnotherConfirmation"><var>scheduleAnotherConfirmation()</var></a>, &nbsp;
                    <a href="#scheduleAnotherSubmit"><var>scheduleAnotherSubmit()</var></a>, &nbsp;
                    <a href="#tryConfirm"><var>tryConfirm()</var></a>, &nbsp;
                    <a href="#trySubmit"><var>trySubmit()</var></a>, &nbsp;
                    <a href="#txExpired"><var>txExpired()</var></a>, &nbsp;
                    <a href="#wasUpdated"><var>wasUpdated()</var></a>
        </p>
...
<div className="prose">
        ...
        <ReactMarkdown>
            ...
            <pre><code lang="typescript">
{"$mgrState: "}<a href="#SubmitManagerState">{"SubmitManagerState"}</a>{";"}
            </code></pre>
...
<div className="prose">
        ...
        <ReactMarkdown>
            ...
            <pre><code lang="typescript">
{"get initialState(): "}<a href="#TxSubmitterStates">{"TxSubmitterStates"}</a>{";"}
            </code></pre>
...
<div className="prose">
        ...
        <ReactMarkdown>
            ...
            <pre><code lang="typescript">
{"get network(): "}<a href="#CardanoClient">{"CardanoClient"}</a>{";"}
            </code></pre>
...
<div className="prose">
        ...
        <ReactMarkdown>
            ...
            <pre><code lang="typescript">
{"onEntry: "}{"{\n        submitting: () => void;\n        confirming: () => "}<a href="#Promise">{"Promise"}</a>{"<void>;\n        softConfirmed: () => "}<a href="#Promise">{"Promise"}</a>{"<void> | undefined;\n        failed: () => void;\n    }"}{";"}
            </code></pre>
...
<div className="prose">
        ...
        <ReactMarkdown>
            ...
            <pre><code lang="typescript">
{"pending: "}{"("}<a href="#WrappedPromise">{"WrappedPromise"}</a>{"<any> & {\n        activity: string;\n    }) | undefined"}{";"}
            </code></pre>
...
<div className="prose">
        ...
        <ReactMarkdown>
            ...
            <pre><code lang="typescript">
{"retryIntervals: "}<a href="#Required">{"Required"}</a>{"<"}<a href="#SubmitterRetryIntervals">{"SubmitterRetryIntervals"}</a>{">"}{";"}
            </code></pre>
...
<div className="prose">
        ...
        <ReactMarkdown>
            ...
            <pre><code lang="typescript">
{"submitter: "}<a href="#CardanoTxSubmitter">{"CardanoTxSubmitter"}</a>{";"}
            </code></pre>
...
<div className="prose">
        ...
        <ReactMarkdown>
            ...
            <pre><code lang="typescript">
{"transitionTable: "}<a href="#StateTransitionTable">{"StateTransitionTable"}</a>{"<"}<a href="#TxSubmitterStates">{"TxSubmitterStates"}</a>{", "}<a href="#TxSubmitterTransitions">{"TxSubmitterTransitions"}</a>{">"}{";"}
            </code></pre>
...
<div className="prose">
        ...
        <ReactMarkdown>
            ...
            <pre><code lang="typescript">
{"txd: "}<a href="#TxDescription">{"TxDescription"}</a>{"<any, \"signed\">"}{";"}
            </code></pre>
...
{"get txId(): "}<a href="#TxId">{"TxId"}</a>{";"}
    ...
    <h3>Instance methods</h3>
        ...
        <ReactMarkdown>
            {
                "mockable method for finding the tx from the submitter, which is a confirmation that it was submitted successfully\n"
            }
        </ReactMarkdown>
    </div>
...
<p></p>
            ...
            <pre><code lang="typescript">
{"confirmTx(): "}<a href="#Promise">{"Promise"}</a>{"<boolean>"}{";"}
            </code></pre>
...
<p></p>
            ...
            <pre><code lang="typescript">
{"doSubmit(): "}<a href="#Promise">{"Promise"}</a>{"<"}<a href="#TxId">{"TxId"}</a>{" | undefined>"}{";"}
            </code></pre>
...
<div className="prose">
        <a id="inputUtxosAreResolvable"></a>

            <div>
        <h4 style={{display: "inline-block"}}>    {
              "inputUtxosAreResolvable"}()&nbsp;&nbsp;</h4>
        <ReactMarkdown>
            {
                ""
            }
            ...
            <pre><code lang="typescript">
{"inputUtxosAreResolvable(): "}<a href="#Promise">{"Promise"}</a>{"<boolean>"}{";"}
            </code></pre>
...
<p></p>
            ...
            <pre><code lang="typescript">
{"isExpiryError(problem: "}<a href="#Error">{"Error"}</a>{"): "}{"boolean"}{";"}
            </code></pre>
...
<div className="prose">
        ...
        <ReactMarkdown>
            ...
            <pre><code lang="typescript">
{"isTxExpired(tx: "}<a href="#Tx">{"Tx"}</a>{"): "}{"boolean"}{";"}
            </code></pre>
...
<div className="prose">
        <a id="isUnknownUtxoError"></a>

            <div>
        <h4 style={{display: "inline-block"}}>    {
              "isUnknownUtxoError"}()&nbsp;&nbsp;</h4>
        <ReactMarkdown>
            {
                "mockable method for checking an error (provided by the submitter) to see if the submitter understands it to be of the \"unknown UTXO\" type\n\n"
            }
        </ReactMarkdown>
    </div>
...
<p></p>
        ...
        <ReactMarkdown> {
            "\n\nWhen a utxo is unknown, it can mean it was existing and is now spent, or it can mean it was not yet known to exist. The error message can potentially indicate either of these cases, and ideally the submitter can tell the difference. In any case, a truthy response indicates that the tx is not yet submittable.\n"
        }</ReactMarkdown>
            <pre><code lang="typescript">
{"isUnknownUtxoError(problem: "}<a href="#Error">{"Error"}</a>{"): "}{"boolean"}{";"}
            </code></pre>
...
<div className="prose">
        ...
        <ReactMarkdown>
            ...
            <pre><code lang="typescript">
{"notConfirmed(problem?: "}<a href="#Error">{"Error"}</a>{"): "}{"void"}{";"}
            </code></pre>
...
<div className="prose">
        <a id="nothingPendingAllowed"></a>

            <div>
        <h4 style={{display: "inline-block"}}>    {
              "nothingPendingAllowed"}()&nbsp;&nbsp;</h4>
        <ReactMarkdown>
            {
                ""
            }
...
<div className="prose">
        ...
        <ReactMarkdown>
            ...
            <pre><code lang="typescript">
{"notSubmitted(problem: "}<a href="#Error">{"Error"}</a>{"): "}<a href="#Promise">{"Promise"}</a>{"<void>"}{";"}
            </code></pre>
...
<div className="prose">
        <a id="otherSubmitterProblem"></a>

            <div>
        <h4 style={{display: "inline-block"}}>    {
              "otherSubmitterProblem"}()&nbsp;&nbsp;</h4>
        <ReactMarkdown>
            {
                ""
            }
...
<div className="prose">
        ...
        <ReactMarkdown>
            ...
            <pre><code lang="typescript">
{"pendingActivity<P>(activityName: "}{"string"}{", p: "}<a href="#Promise">{"Promise"}</a>{"<P>"}{"): "}<a href="#Promise">{"Promise"}</a>{"<P | undefined>"}{";"}
            </code></pre>
...
<div className="prose">
        <a id="resetConfirmationStats"></a>

            <div>
        <h4 style={{display: "inline-block"}}>    {
              "resetConfirmationStats"}()&nbsp;&nbsp;</h4>
        <ReactMarkdown>
            {
                ""
            }
...
<div className="prose">
        <a id="scheduleAnotherConfirmation"></a>

            <div>
        <h4 style={{display: "inline-block"}}>    {
              "scheduleAnotherConfirmation"}()&nbsp;&nbsp;</h4>
        <ReactMarkdown>
            {
                ""
            }
            ...
            <pre><code lang="typescript">
{"scheduleAnotherConfirmation(this: "}{"this"}{", transitionName: "}<a href="#TxSubmitterTransitions">{"TxSubmitterTransitions"}</a>{", reason: "}{"string"}{", backoff?: "}{"number"}{"): "}<a href="#DeferredState_2">{"DeferredState_2"}</a>{"<this>"}{";"}
            </code></pre>
...
<div className="prose">
        <a id="scheduleAnotherSubmit"></a>

            <div>
        <h4 style={{display: "inline-block"}}>    {
              "scheduleAnotherSubmit"}()&nbsp;&nbsp;</h4>
        <ReactMarkdown>
            {
                ""
            }
            ...
            <pre><code lang="typescript">
{"scheduleAnotherSubmit(transitionName: "}<a href="#TxSubmitterTransitions">{"TxSubmitterTransitions"}</a>{", displayStatus: "}{"string"}{", backoff?: "}{"number"}{"): "}<a href="#DeferredState_2">{"DeferredState_2"}</a>{"<this>"}{";"}
            </code></pre>
...
<div className="prose">
        ...
        <ReactMarkdown>
            ...
            <pre><code lang="typescript">
{"tryConfirm(): "}<a href="#Promise">{"Promise"}</a>{"<void>"}{";"}
            </code></pre>
...
<div className="prose">
        ...
        <ReactMarkdown>
            ...
            <pre><code lang="typescript">
{"trySubmit(): "}<a href="#Promise">{"Promise"}</a>{"<void>"}{";"}
            </code></pre>
