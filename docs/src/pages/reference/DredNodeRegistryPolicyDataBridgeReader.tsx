...
export default function DocumentItem() {
    return (
        <div>
                <h2>DredNodeRegistryPolicyDataBridgeReader</h2>
                    <ReactMarkdown>
                        {
                            ""
                        }
         ...
         <p>
            <b>Instance methods: </b>
                    <a href="#AbstractSettingsForNodeOperator"><var>AbstractSettingsForNodeOperator()</var></a>, &nbsp;
                    ...
                    <a href="#dgd_DataSrc"><var>dgd_DataSrc()</var></a>, &nbsp;
                    <a href="#DgDataDetails"><var>DgDataDetails()</var></a>, &nbsp;
                    ...
                    <a href="#NodeRegistrationData"><var>NodeRegistrationData()</var></a>, &nbsp;
...
{"bridge: "}<a href="#DredNodeRegistryPolicyDataBridge">{"DredNodeRegistryPolicyDataBridge"}</a>{";"}
            </code></pre>
...
{"datum: "}{"(d: "}<a href="#UplcData">{"UplcData"}</a>{") => "}<a href="#Partial">{"Partial"}</a>{"<{\n        Cip68RefToken: "}<a href="#DelegateDatum$Ergo$Cip68RefToken">{"DelegateDatum$Ergo$Cip68RefToken"}</a>{";\n        IsDelegation: "}<a href="#ErgoDelegationDetail">{"ErgoDelegationDetail"}</a>{";\n        capoStoredData: "}<a href="#DelegateDatum$Ergo$capoStoredData">{"DelegateDatum$Ergo$capoStoredData"}</a>{";\n    }>"}{";"}
    ...
    <h3>Instance methods</h3>
        <div className="prose">
        <a id="AbstractSettingsForNodeOperator"></a>

            <div>
        <h4 style={{display: "inline-block"}}>    {
              "AbstractSettingsForNodeOperator"}()&nbsp;&nbsp;</h4>
        <ReactMarkdown>
            {
...
<p></p>
            ...
            <pre><code lang="typescript">
{"AbstractSettingsForNodeOperator(d: "}<a href="#UplcData">{"UplcData"}</a>{"): "}<a href="#AbstractSettingsForNodeOperator">{"AbstractSettingsForNodeOperator"}</a>{";"}
            </code></pre>
...
<div className="prose">
        <a id="NodeRegistrationData"></a>

            <div>
        <h4 style={{display: "inline-block"}}>    {
              "NodeRegistrationData"}()&nbsp;&nbsp;</h4>
        <ReactMarkdown>
            {
...
<p></p>
            ...
            <pre><code lang="typescript">
{"NodeRegistrationData(d: "}<a href="#UplcData">{"UplcData"}</a>{"): "}<a href="#NodeRegistrationData">{"NodeRegistrationData"}</a>{";"}
            </code></pre>
