...
} from "./MyMintSpendDelegate.typeInfo.js";

export type * as types from "./MyMintSpendDelegate.typeInfo.js";
import type * as types from "./MyMintSpendDelegate.typeInfo.js";
...
* @public
 */
export class MyMintSpendDelegateDataBridge extends ContractDataBridge {
...
export default MyMintSpendDelegateDataBridge;

/**
 * @public
 */
export class MyMintSpendDelegateDataBridgeReader extends DataBridgeReaderClass {
    constructor(public bridge: MyMintSpendDelegateDataBridge, isMainnet: boolean) {
        super();
    }
...
export class DelegateActivityHelper extends EnumBridge<isActivity> {
    ...
    * This activity  uses the pattern of spending a utxo to provide a uniqueness seed.
    ...
    OtherActivities(
        ...
        }, "STokMintDelegate::DelegateActivity.OtherActivities"); /*singleField enum variant*/
       return uplc;
    }
}/*mkEnumHelperClass*/
...
export const DelegateActivitySchema : EnumTypeSchema = {
    ...
    "variantTypes": [
        ...
        },
        {
            "kind": "variant",
            "tag": 9,
            "id": "__module__STokMintDelegate__DelegateActivity[]__OtherActivities",
