...
export type * as types from "./NodeRegistry.typeInfo.js";
...
* @public
 */
export class DredNodeRegistryPolicyDataBridge extends ContractDataBridge {
...
export default DredNodeRegistryPolicyDataBridge;

/**
 * @public
 */
export class DredNodeRegistryPolicyDataBridgeReader extends DataBridgeReaderClass {
...
datum = (d: UplcData) => { return this.DelegateDatum(d) }
    ...
    /**
        ...
        * causes some error later on in your code, when you try to use it.
        */
    NodeRegistrationData(d: UplcData) {
        const cast = this.bridge.ᱺᱺNodeRegistrationDataCast;
        return cast.fromUplcData(d) //??? as ErgoNodeRegistrationData;
    } /* structReader helper */
...
/**
 * Helper class for generating UplcData for the struct ***NodeRegistrationData*** type.
 * @public
 */
export class NodeRegistrationDataHelper extends DataBridge {
    isCallable = true
   /**
            * @internal
            * uses unicode U+1c7a - sorts to the end */
    ᱺᱺcast = makeCast<NodeRegistrationData, NodeRegistrationDataLike>(
        NodeRegistrationDataSchema,
        { isMainnet: this.isMainnet, unwrapSingleFieldEnumVariants: true }
    );
...
export class DelegateDatumHelper extends EnumBridge<JustAnEnum> {
    ...
    tn: /*minStructField*/ number[]
        ...
        const uplc = this.mkUplcData({ 
           IsDelegation: dd
        }, "DredNodeRegistryPolicy::DelegateDatum.IsDelegation"); /*singleField enum variant*/
        return makeInlineTxOutputDatum(uplc);
    }
...
export class BurningActivityHelper extends EnumBridge<JustAnEnum> {
    ...
    DeletingRecord(
        ...
        const uplc = this.mkUplcData({ 
           DeletingRecord: id
        }, "DredNodeRegistryPolicy::BurningActivity.DeletingRecord"); /*singleField enum variant*/
       return uplc;
    }
}/*mkEnumHelperClass*/
 ...
 */
    get Placeholder() {
        const uplc = this.mkUplcData({ Placeholder: {} }, 
            "DredNodeRegistryPolicy::OtherActivity.Placeholder");
        return uplc;
    } /* tagOnly variant accessor */
}/*mkEnumHelperClass*/
...
export const OtherActivitySchema : EnumTypeSchema = {
    "kind": "enum",
    "name": "OtherActivity",
    "id": "__module__DredNodeRegistryPolicy__OtherActivity[]",
    "variantTypes": [
        {
            "kind": "variant",
            "tag": 42,
            "id": "__module__DredNodeRegistryPolicy__OtherActivity[]__Placeholder",
            "name": "Placeholder",
            "fieldTypes": []
        }
    ]
...
export const DelegateActivitySchema : EnumTypeSchema = {
    ...
    "variantTypes": [
        ...
        },
        {
            "kind": "variant",
            "tag": 9,
            "id": "__module__DredNodeRegistryPolicy__DelegateActivity[]__OtherActivities",
