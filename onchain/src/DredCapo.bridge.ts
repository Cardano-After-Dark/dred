...
} from "./DredCapo.typeInfo.js";

export type * as types from "./DredCapo.typeInfo.js";
import type * as types from "./DredCapo.typeInfo.js";



/**
 * GENERATED data bridge for **Capo** script (defined in class ***DredCapoBundle***)
 * main: **src/DefaultCapo.hl**, project: **stellar-contracts**
 * @remarks - note that you may override `get dataBridgeName() { return "..." }` to customize the name of this bridge class
* @public
 */
export class DredCapoBridge extends ContractDataBridge {
    ...
    reader = new DredCapoBridgeReader(this, this.isMainnet);
...
export default DredCapoBridge;

/*
 * @public
 */
export class DredCapoBridgeReader extends DataBridgeReaderClass {
    constructor(public bridge: DredCapoBridge, isMainnet: boolean) {
        super();
    }
    /**
