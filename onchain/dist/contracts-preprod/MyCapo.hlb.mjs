import { CapoHeliosBundle, capoConfigurationDetails } from '@donecollectively/stellar-contracts';

class MyCapoBundle extends CapoHeliosBundle {
...
export { MyCapoBundle as default };
//# sourceMappingURL=MyCapo.hlb.mjs.map
